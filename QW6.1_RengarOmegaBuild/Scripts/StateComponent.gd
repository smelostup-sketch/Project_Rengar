...
@export_range(0.1, 3.0, 0.05) var movement_speed_multiplier: float = 1.0
...
func apply_physics(delta: float) -> void:
	...
	if input_dir == Vector3.ZERO:
		...
		var target_vel := target_dir * speed * movement_speed_multiplier
		desired_horizontal_speed = speed * movement_speed_multiplier
